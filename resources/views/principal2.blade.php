...
@section('content')
    <div class="container" style="background-color: #c39bd3" onload="javascript:cambio()">
        <br>
        <form id="formulario"name="formulario" method="POST" action="{{ route('principal2') }}" role="form"
