...
@section('content')
    <div class="container" style="background-color: orange" onload="javascript:cambio()">
        <br>
        <form id="formulario"name="formulario" method="POST" action="{{ route('orange') }}" role="form"
